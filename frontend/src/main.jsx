...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="page-shell">
      ...
      {route.view === 'browse' && <>
        <section className="browse-intro"><div><span className="eyebrow">Safer device decisions</span><h1>Find a device that fits.</h1><p>Compare devices for home, business or public-sector use. See the security trade-offs and practical steps in plain English.</p></div><div className="status-panel"><strong>{catalogueStateLabel(catalogueStatus)}</strong><span>{catalogueStatus?.product_count ?? '—'} products · {catalogueStatus?.current_offer_count ?? 0} current offers</span><small>Prices and evidence are labelled by freshness.</small></div></section>
